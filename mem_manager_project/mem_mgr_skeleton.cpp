...
void fifo_replace_page(size_t& frame) 
{
    ...
    pg_table[index].is_present= 0;
    pg_table[index].is_used = 0;
    pg_table[index].npage = -1;    
}   
...
void check_address_value(size_t logic_add, size_t page, size_t offset, size_t physical_add, size_t& prev_frame, size_t frame, int val, int value, size_t o) 
{
